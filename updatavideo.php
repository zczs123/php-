...
if(isset($_POST['token'])&&$_POST['token']=='update')
{
    $id=$_GET['id'];
    $title=$_POST['title'];
    $pptsrc=$_POST['videosrc'];
    $intro=$_POST['intro'];
    $hits=$_POST['hits'];
    $imgsrc=$_POST['imgsrc'];
    $sql= "UPDATE video SET title= '$title', videosrc= '$videosrc',intro= '$intro', hits= '$hits', imgsrc= '$imgsrc' WHERE id=$id";
...
<h2>信息修改表</h2>
    ...
    <tr>
    <td width="80px">资源路径:</td><td> <input type="text" name="videosrc" value="请输入新的资源路径"></td>
    </tr>
    <tr>
